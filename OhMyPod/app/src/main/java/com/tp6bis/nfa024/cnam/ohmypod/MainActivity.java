package com.tp6bis.nfa024.cnam.ohmypod;
...
public class MainActivity extends Activity implements LocationListener {
            ...
            this.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        spot = MainActivity.this.data.getJSONArray("records").getJSONObject(0);
    ...
    public void onLocationChanged(Location alocation) {
        try {
            ...
            borne.setLatitude(MainActivity.this.position.getDouble(0));
            borne.setLongitude(MainActivity.this.position.getDouble(1));
            int distance = (int) borne.distanceTo(alocation);
            this.myTitle.setText(p + "\n" + distance + " metres");
        } catch (JSONException e) {
        }
    }

    @Override
    public void onStatusChanged(String provider, int arg, Bundle arg2) {
    }
    ...
    public void onResume() {
        ...
        this.zeLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 1000, 1, this);
        this.zeLocationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 1000, 1, this);
